<template>
  <div class="rounded-lg bg-white shadow-sm -mt-2">
    <v-card-actions class="m-2 flex flex-col">
      <button class="flex items-center w-full px-4 py-3 rounded-full justify-start focus:outline-none bg-gray-100 hover:bg-gray-200 active:bg-gray-50 mt-2 border-2 border-gray-900"
             @click="dialog = true">
        <svg xmlns="http://www.w3.org/2000/svg" 
              viewBox="0 0 24 24" 
              data-supported-dps="24x24" 
              fill="currentColor" 
              class="mercado-match w-6 h-6 mr-3 text-gray-500"
              focusable="false">
      ...
      <div class="flex items-center justify-between mt-2">
        <v-btn text class="flex focus:outline-none capitalize text-capitalize">
          <svg fill="currentColor" 
            ...
            <path xmlns="http://www.w3.org/2000/svg" 
                  d="M24.232 8.541a2.2 2.2 0 101.127.623 2.212 2.212 0 00-1.127-.623M18.111 20.1q-2.724-3.788-5.45-7.575L4.579 23.766h10.9q1.316-1.832 2.634-3.663M22.057 16q-2.793 3.882-5.584 7.765h11.169Q24.851 19.882 22.057 16z" 
                  fill="#fff">
            </path>
          </svg>
        ...
        <v-btn text class="flex focus:outline-none capitalize text-capitalize">
          <svg xmlns="http://www.w3.org/2000/svg" 
                ...
                data-supported-dps="24x24" 
                fill="currentColor" 
                class="mercado-match w-6 h-6 mr-2 text-yellow-500" 
                focusable="false">
        ...
        <v-btn text class="flex focus:outline-none capitalize text-capitalize">
          <svg xmlns="http://www.w3.org/2000/svg" 
                ...
                data-supported-dps="24x24" 
                fill="currentColor" 
                class="mercado-match w-6 h-6 mr-2 text-green-500" 
                focusable="false">
